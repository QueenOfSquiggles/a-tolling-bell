...
func get_prototype_stack_size(prototype_id: String) -> int:
	return _constraint_manager.get_stacks_constraint().get_prototype_stack_size(
		item_protoset, prototype_id
	)


func get_prototype_max_stack_size(prototype_id: String) -> int:
	return _constraint_manager.get_stacks_constraint().get_prototype_max_stack_size(
		item_protoset, prototype_id
	)
